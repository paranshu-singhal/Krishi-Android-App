...
public class RegisterActivity extends AppCompatActivity {
        ...
        mSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean success = AttemptRegister(mPerson.getText().toString(), mPassword.getText().toString(), mPhone.getText().toString(),
                        mAddress1.getText().toString(), mAddress2.getText().toString(), mState.getText().toString(), mCountry.getText().toString());

                if(success) {
                    NewRegister reg = new NewRegister(mPerson.getText().toString(), mPassword.getText().toString(), mPhone.getText().toString(),
                            mAddress1.getText().toString(), mAddress2.getText().toString(), mState.getText().toString(),  mCountryString,tag);
    ...
    private boolean AttemptRegister(String name, String password, String phone, String address1, String address2, String state, String country){
        if(name.length()<=0){
    ...
    private class NewRegister extends AsyncTask<Void,Void,String>{
        ...
        NewRegister(String name, String password, String phone, String address1, String address2, String state, String country, String tag) {
            this.name = name;
        ...
        protected String doInBackground(Void... params) {
            ...
            String answer = null;
            try {
                HttpURLConnection conn = (HttpURLConnection) (new URL("http://10.0.0.5/krishi/index2.php")).openConnection();
        ...
        protected void onPostExecute(String answer) {
            ...
            try {
                ...
                if(json.getString("success").equals("1")){
                    Snackbar.make(mPerson,getResources().getString(R.string.user_registration_successful), Snackbar.LENGTH_SHORT).show();
